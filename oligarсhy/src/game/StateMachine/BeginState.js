...
export default class BeginState extends State {
    ...
    restoreSelection() {
        ...
        context.dice1.select();
        context.dice2.select();
    }
     ...
     */
     getAiNextPoint(ai) {
        return Utils.toPoint(ai._context.dice1.toGameObject());
    }
    ...
    _tryTakeDice(point, dice) {
        ...
        return hand.tryMakeAction(
            ...
            () => {
                me.core._setState(Enums.GameState.FIRST_DICE_TAKED)
            });
    }
}